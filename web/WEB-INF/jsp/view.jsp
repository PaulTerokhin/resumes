...
<%@ page import="basejava.model.ListSection" %>
    ...
    <div class="form-wrapper">
        ...
        <c:forEach var="sectionEntry" items="${resume.sections}">
            <jsp:useBean id="sectionEntry"
                         type="java.util.Map.Entry<basejava.model.SectionType, basejava.model.Section>"/>
            <c:set var="type" value="${sectionEntry.key}"/>
            <c:set var="section" value="${sectionEntry.value}"/>
            <jsp:useBean id="section" type="basejava.model.Section"/>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>">
                        <div class="section-wrapper">
                            ...
                            <c:forEach var="position" items="${org.positions}">
                                <jsp:useBean id="position" type="basejava.model.Organization.Position"/>
